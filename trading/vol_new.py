...
Volatility-harvesting version (no mean-revert exit)
"""
...
class Strategy:
    ...
    def on_game_event_update(self, *args, **kwargs) -> None:
        ...
        is handled via your own events OR elsewhere if you prefer.
        """
        try:
            now = kwargs.get("timestamp") or kwargs.get("ts") or kwargs.get("time")
            if now is None:
                # heuristic: use the last numeric positional arg as a time-like value
        ...
        # Optional: If you do have scores in kwargs, you can keep rollover detection here.
        ...
        try:
            ...
            # If engine sends unexpected shapes, just no-op safely.
            pass
